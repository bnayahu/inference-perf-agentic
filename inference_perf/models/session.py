...
that triggers a multi-turn agent loop. This is equivalent to one trace
in OTel terminology.
"""
...
class Session(BaseModel):
    ...
    # Computed properties for session summary
    @computed_field
    @property
    ...
    def add_turn(self, turn: Turn) -> None:
        ...
        # Compute new_context_tokens if not set
    ...
    def from_dict(cls, data: dict) -> "Session":
        ...
        # Extract only the fields needed for construction
...
class SessionSummary(BaseModel):
    ...
    This is a flattened representation of the session's key metrics,
    suitable for aggregation and reporting without the full turn details.
